...
| File | Purpose |
|------|---------|
| `index.html` | Main UI shell — logic in **`PCHost/web/js/workspace_app.js`** + satellite modules (**P10 ship**; optional **P10b** = further split). |
...
| ~~`ocr.html`~~ | Removed — OCR is only from the main workspace (`index.html`). |
