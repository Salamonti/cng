...
SUPPORTED_DOMAINS: List[str] = [
    # Core — broad clinical focus first
    "clinical_general",
    "cardiology",
    "pulmonology",
    "endocrinology",
...
DOMAIN_FILTERS_INCLUDE: Dict[str, Dict[str, List[str]]] = {
    ...
    "pulmonology": {
        "mesh": ["Asthma", "Pulmonary Disease, Chronic Obstructive", "Pulmonary Embolism", "Interstitial Lung Diseases", "Respiratory Insufficiency", "Pneumonia", "Bronchiectasis", "Sarcoidosis", "Pulmonary Fibrosis", "Sleep Apnea Syndromes", "Pneumothorax", "Pleural Effusion", "Tuberculosis", "Cystic Fibrosis", "Pulmonary Hypertension", "Respiratory Distress Syndrome, Newborn", "Acute Respiratory Distress Syndrome"],
        "keywords": ["FEV1", "GOLD guideline", "oxygen therapy", "DLCO", "VTE", "anticoagulation", "lung", "respiratory", "pulmonary", "bronchitis", "pneumonia", "cough", "dyspnea", "chest", "ILD", "fibrosis", "emphysema", "bronchiectasis", "sarcoidosis", "sleep apnea", "OSA", "pleural", "effusion", "pneumothorax", "tuberculosis", "TB", "cystic fibrosis", "CF", "asthma", "COPD", "pulmonary hypertension", "PH", "pulmonary fibrosis", "IPF", "aspiration", "atelectasis", "ARDS", "respiratory failure", "mechanical ventilation", "intubation", "bronchoscopy", "spirometry", "pulmonary function", "PFT", "hypoxemia", "hypercapnia", "blood gas", "ABG", "ventilator", "NIV", "CPAP", "BiPAP", "oxygen saturation", "pulse oximetry", "capnography", "bronchodilator", "steroid", "inhaler", "nebulizer", "mucolytic", "expectorant", "corticosteroid", "theophylline", "anticholinergic", "beta-agonist", "LABA", "SABA", "ICS", "LAMA", "tiotropium", "salmeterol", "formoterol", "fluticasone", "budesonide", "beclomethasone", "montelukast", "zafirlukast", "omalizumab", "mepolizumab", "benralizumab", "dupilumab", "tezepelumab", "roflumilast", "pirfenidone", "nintedanib"],
    },
    "clinical_general": {
        "mesh": ["Practice Guidelines as Topic", "Randomized Controlled Trials as Topic", "Systematic Reviews as Topic", "Meta-Analysis as Topic", "Treatment Outcome", "Patient Selection", "Clinical Decision-Making", "Evidence-Based Medicine", "Disease Management", "Therapeutics", "Drug Therapy", "Adjuvant Therapy", "Palliative Care", "Symptom Management", "Pain Management", "Quality of Life", "Shared Decision Making", "Compliance", "Adherence", "Medication Adherence", "Dose-Response Relationship, Drug", "Drug Dosage", "Drug Interactions", "Adverse Drug Reactions", "Drug-Related Side Effects and Adverse Reactions", "Contraindications", "Therapeutic Failure", "Referral and Consultation", "Continuity of Patient Care", "Follow-Up Studies", "Prognosis", "Survival Rate", "Mortality", "Recurrence", "Remission"],
        "keywords": ["treatment", "management", "therapy", "diagnosis", "prognosis", "outcome", "clinical trial", "randomized", "controlled", "cohort", "prospective", "retrospective", "intervention", "prevention", "screening", "diagnostic test", "biomarker", "imaging", "ultrasound", "CT scan", "MRI", "X-ray", "endoscopy", "biopsy", "surgery", "procedure", "operation", "angioplasty", "stent", "dialysis", "transplant", "transfusion", "chemotherapy", "radiation", "immunotherapy", "targeted therapy", "hormone therapy", "vaccine", "antibody", "monoclonal", "biologic", "drug", "medication", "injection", "infusion", "oral", "topical", "inhalation", "subcutaneous", "intravenous", "parenteral", "transdermal"],
    },
    "endocrinology": {
...
GLOBAL_EXCLUDE_KEYWORDS: List[str] = [
    ...
    # Non-clinical study types — exclude basic science that won't affect patient management
    "in vitro", "in silico", "cell line", "cell culture", "transgenic",
    "knockout", "animal model", "mouse model", "rat model", "zebrafish",
    "drosophila", "c. elegans", "yeast", "bacterial", "plasmid",
    "gene expression", "signal transduction", "molecular mechanism",
    "protein structure", "crystallography", "spectroscopy",
    "bioinformatics", "computational modeling", "molecular dynamics",
]
